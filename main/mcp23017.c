/*
 * MCP23017 Driver - https://github.com/NSBum/esp32-mcp23017-demo
 *
 */
...
/*
 * This is the cpp definition of the MCP23017 write.
 */
mcp23017_err_t MCP23017Write(mcp23017_gpio_t group, uint8_t v) {
    return mcp23017_write_register(&mcp, MCP23017_GPIO, group, v);
}

/*
 * Write MCP23017 A and B ports.
 */
mcp23017_err_t MCP23017WriteBoth(int v) {
    mcp23017_err_t err;
//    v = ~v;
    err = mcp23017_write_register(&mcp, MCP23017_GPIO, GPIOA, v & 0xff);
    if (err)
        return err;
    return mcp23017_write_register(&mcp, MCP23017_GPIO, GPIOB, (v >> 8) & 0xff);
}
