...
class CChannel {
public:
	// Configuration if this is a DS18B20.
	C18b20 T18b20;
	// Configuration if this is a MAX31856 thermocouple.
	CMAX31856 MAX31856;
	// The last reading.
	float ValueCurrent;
	// Temperature unit
	...
	while (1) {
		...
		for (int i=0; i<NUM_CHANNELS; i++) {
			...
			if (Config.ChannelsAr[i].SensorType == CChannel::SensorTypeE::TMAX31856) {
				...
				float Temp = Config.ChannelsAr[i].T18b20.ds18b20_get_temp();
...
#define WEB_PORT 80
#define WEB_URL "http://192.168.100.250/index.php"
